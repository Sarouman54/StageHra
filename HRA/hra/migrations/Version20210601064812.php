 ...
 */
final class Version20210601064812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE truck ADD id_driver_id INT DEFAULT NULL, ADD id_card_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE truck DROP id_driver_id, DROP id_card_id');
    }
}
