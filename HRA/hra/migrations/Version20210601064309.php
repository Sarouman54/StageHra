 ...
 */
final class Version20210601064309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE data ADD id_user_id INT DEFAULT NULL, ADD id_truck_id INT DEFAULT NULL');
